#!/usr/bin/env python3
"""Run the Lab K-means classical segmenter through the evaluation harness.

Usage:
    python scripts/run_classical.py                    # evaluate on test
    python scripts/run_classical.py --split val        # tune on val

Writes per-image metrics to results/classical_lab_kmeans_per_image.csv
